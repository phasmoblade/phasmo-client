...
public final class ThunderUtility {
    ...
    public static void syncVersion() {
        try {
            if (!new BufferedReader(new InputStreamReader(new URL("https://raw.githubusercontent.com/phasmoblade/PhasmoClientUtil/main/SyncVersion2025.txt").openStream())).readLine().equals(ThunderHack.VERSION))
