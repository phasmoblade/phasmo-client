...
public final class RPC extends Module {
    ...
    public static Setting<Mode> mode = new Setting<>("Picture", Mode.Phasmo);
    ...
    public static Setting<String> state = new Setting<>("State", "Phasmo Client - Best Minecraft Client!");
    ...
    public static void readFile() {
        try {
            File file = new File("PhasmoClient/misc/RPC.txt");
            if (file.exists()) {
    ...
    public void startRpc() {
        ...
        if (!started) {
            ...
            rpc.Discord_Initialize("1420691194471518308", handlers, true, "");
            presence.startTimestamp = (System.currentTimeMillis() / 1000L);
            presence.largeImageText = "Phasmo Client v" + ThunderHack.VERSION + " [" + ThunderHack.GITHUB_HASH + "]";
            ...
            thread = new Thread(() -> {
                while (!Thread.currentThread().isInterrupted()) {
                    ...
                    presence.button_url_1 = "https://github.com/phasmoblade/phasmo-client";

                    switch (mode.getValue()) {
                        case Phasmo -> presence.largeImageKey = "phasmo_client";
                        case MegaCute ->
    ...
    public enum Mode {Custom, MegaCute, Phasmo}
